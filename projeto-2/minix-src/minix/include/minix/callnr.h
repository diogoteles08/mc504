...
#define PM_SPADMON_PS		(PM_BASE + 48)
#define PM_SPADMON_SWAP		(PM_BASE + 49)
...
#define VFS_SPADMON_SWAP	(VFS_BASE + 64)
...
#define SPADMON_PS		(SPADMON_BASE + 0)
#define SPADMON_R		(SPADMON_BASE + 1)
#define SPADMON_S		(SPADMON_BASE + 2)
#define SPADMON_T		(SPADMON_BASE + 3)
#define SPADMON_Z		(SPADMON_BASE + 4)
#define SPADMON_E		(SPADMON_BASE + 5)

#define NR_SPADMON_CALLS		6	/* highest number from base plus one */
